	...
	<view>
		<view class="header" v-bind:class="{'status':isH5Plus}">
			<view class="userinfo">
				...
				<view class="info">
					<view class="username">用户ID：3215{{userinfo.id}}</view>
					<view class="integral">今日收入:¥{{userinfo.todayIncome}}元</view>
				</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				severList:[
					[
						{name:'马上提现',icon:'money.png'},
						{name:'账户明细',icon:'mingxi.png'},
						{name:'支付宝',icon:'quan.png'},
						{name:'审核列表',icon:'point.png'},
